import{d as p,Y as _,I as d,b as a,e as t,x as s,z as r,F as u,X as h,o as n,Z as f,l as v,g}from"../modules/vue-6QpwdnMK.js";import{k as x,c as m,f as b,t as y,b as N}from"../index-Do9qY0ie.js";import{N as k}from"./NoteDisplay-Crv5c96f.js";import"../modules/shiki-Ceez9vfC.js";const w={id:"page-root"},L={class:"m-4"},T={class:"mb-10"},V={class:"text-4xl font-bold mt-2"},B={class:"opacity-50"},D={class:"text-lg"},H={class:"font-bold flex gap-2"},S={class:"opacity-50"},j=t("div",{class:"flex-auto"},null,-1),z={key:0,class:"border-main mb-8"},C=p({__name:"print",setup(F){_(`
@page {
  size: A4;
  margin-top: 1.5cm;
  margin-bottom: 1cm;
